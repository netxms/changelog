...
- Fixed issues:
	...
	NX-2180 (Adde cluster binding under subnets)
...
- Fixed issues:
	...
	NX-1333 (nxdbmgr -s/-S export raw_dci_values)
...
- Fixed issues:
	...
	NX-1059 (Установить дефолтную сортировку в log'ах (например event log))
...
- Fixed issues:
	...
	NX-820 (Set SYS_TABLE_THRESHOLD_ACTIVATED and DEACTIVATED as default in table threshold editor)
...
- Fixed issues:
	...
	NX-977 ((web) Exceptino in Server configuration -> new)
...
- Fixed issues:
	...
	NX-645 (Case-insensitive user names (Чувствительность к регистру у аккаунтов))
