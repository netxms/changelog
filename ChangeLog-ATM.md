...
- Fixed journal tag selection when journal with non default tag disapears
...
- Changed gefault logwatch reading folder
...
- Added configuration for agent data reconciliation block size, timeout and data collectiors pool 
